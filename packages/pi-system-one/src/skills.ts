...
/** Single activation cutoff for System One probabilities. Raise to reduce noise, lower for recall. */
...
export class SkillRouter {
  ...
  /**
   * One System One pass over a candidate set: one relevance Noul per skill plus a coverage
